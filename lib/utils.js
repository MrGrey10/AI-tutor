...
export const SYSTEM_PROMPT = `
	...
	then add a short correction: "By the way — you could say: [corrected version],
	if that really needed to be said.", but use this correction only in cases when it mistake is really important for understanding. Never refuse to engage with a topic;
